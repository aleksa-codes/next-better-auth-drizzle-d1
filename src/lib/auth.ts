...
export const auth = betterAuth({
  ...
  //       html: `
  //         <h1>Welcome to NextOnCloudflare!</h1>
  ...
  //       `,
  //       text: `Welcome to NextOnCloudflare! Click the link to verify your email: ${url}`,
  //     });
  //   },
  // },
  user: {
      ...
      sendDeleteAccountVerification: async ({ user, url }) => {
        await sendEmail({
          ...
          html: `
            ...
            <p>We received a request to delete your NextOnCloudflare account. This action cannot be undone.</p>
